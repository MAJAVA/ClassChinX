...
public class Mail  implements java.io.Serializable {
    ...
    public Mail(Term term, Person personByReceiverPersonId, Person personBySenderPersonId, String type, String text, String date, Boolean receiverDelete, Boolean senderDelete) {
       this.term = term;
       this.personByReceiverPersonId = personByReceiverPersonId;
       this.personBySenderPersonId = personBySenderPersonId;
       this.type = type;
